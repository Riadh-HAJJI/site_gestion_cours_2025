...
<body class="trainers-page">
  ...
  <main class="main">
      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Formateurs</h1>
              <p class="mb-0">Chez gest_Cours, notre force réside dans l'expertise et l'engagement de nos formateurs.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="trainers" class="section trainers">
      ...
      foreach ($formateurs as $le_formateur): ?>
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="100">
            <div class="member-img">
              <img src="<?= $le_formateur['image_formateur'] ?>" class="img-fluid" alt="">
              <div class="social">
