...
image_cours,form.places_disponibles,
  ...
  <main class="main">
    ...
    <section id="courses-course-details" class="courses-course-details section">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-8">
            <img src="<?= $cours['image_cours'] ?>" class="img-fluid" alt="">
          ...
          <div class="col-lg-4">
            ...
            <div class="course-info d-flex justify-content-between align-items-center">
              <h5>Formateur</h5>
              <p><a href="#"><?= $cours['formateur'] ?></a></p>
            </div>

            <div class="course-info d-flex justify-content-between align-items-center">
              <h5>Frais de cours</h5>
              <p>$<?= $cours['prix_cours'] ?></p>
            </div>

            <div class="course-info d-flex justify-content-between align-items-center">
              <h5>Places disponibles</h5>
              <p><?= $cours['places_disponibles'] ?></p>
            </div>
