    ...
    <div class="heading">
      <div class="container">
        <div class="row d-flex justify-content-center text-center">
          <div class="col-lg-10">
            <h1>Mes Cours</h1>
            <p class="mb-0">Découvrez une pédagogie innovante alliant théorie et pratique. Nos formations sur mesure, dispensées par des experts passionnés, vous offrent des compétences concrètes immédiatement applicables. À travers des méthodes interactives et un accompagnement personnalisé, nous transformons les défis d'apprentissage en opportunités de progression. Un programme évolutif adapté à tous les niveaux, avec des ressources actualisées et des cas pratiques sectoriels. Développez votre potentiel grâce à un suivi individualisé et des outils numériques performants pour atteindre vos objectifs professionnels.</p>
          </div>
        </div>
      </div>
    </div>
